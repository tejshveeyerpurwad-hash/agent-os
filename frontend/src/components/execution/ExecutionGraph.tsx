  ...
  return (
    <div className="rounded-xl border border-dark-800 bg-dark-900/50 p-4">
      <h3 className="text-xs font-semibold text-dark-300 uppercase tracking-wider mb-4 flex items-center gap-1.5">
        <Bot className="h-3.5 w-3.5" /> Execution Graph — Parallel Groups
      </h3>
          ...
          >
            <div className="flex items-center gap-2 mb-1.5">
              ...
              {group.length > 1 && (
                <span className="text-[10px] text-dark-600 flex items-center gap-1">
                  <Bot className="h-3 w-3" /> {group.length} parallel tasks
                </span>
              )}
            </div>
            <div className={cn(
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {task.priority === 'high' && (
                            <span className="text-[9px] text-dark-600 flex items-center gap-0.5">
                              <Clock className="h-2.5 w-2.5" /> High
                            </span>
                          )}
                        </div>
                      </div>
            ...
            {gi < groupedByDepth.length - 1 && (
              <div className="flex justify-center my-2">
                <ChevronRight className="h-4 w-4 text-dark-600 rotate-90" />
              </div>
            )}
          </motion.div>
        ))}
